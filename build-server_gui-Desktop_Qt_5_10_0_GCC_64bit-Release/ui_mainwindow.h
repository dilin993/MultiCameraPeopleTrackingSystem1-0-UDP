...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(10, 10, 732, 317));
        ...
        gridLayout_5->addWidget(glob_track_view, 0, 0, 1, 1);
        ...
        overlayView = new QGraphicsView(tab_4);
        overlayView->setObjectName(QStringLiteral("overlayView"));
        overlayView->setGeometry(QRect(0, 0, 781, 531));

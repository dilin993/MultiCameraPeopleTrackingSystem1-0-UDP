    ...
    , f_addr(addr)
{
    ...
    {
        throw udp_client_runtime_error(("invalid address or port: \"" + addr + ":" + decimal_port + "\"").c_str());
    }
    ...
    if(f_socket == -1)
    {
        ...
        throw udp_client_runtime_error(("could not create socket for: \"" + addr + ":" + decimal_port + "\"").c_str());
    }
}
...
//{
//    udp_client::udp_client client1("127.0.0.1",8089);// = new udp_client::udp_client("172.0.0.1",0);
//
//    client1.send("hello",5);
//    return 0;
//}
